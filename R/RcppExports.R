...
gplm_density_evaluation_unknown_c_cpp <- function(theta, P, h, B, dist, A, y, tau, epsilon, h_min, nugget, n_unique, mu_x, Sig_ab, Z, lambda_c, lambda_sb, lambda_pb, lambda_eta_1, lambda_seta) {
