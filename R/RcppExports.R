...
gplm_me_density_evaluation_unknown_c_cpp <- function(theta, P, h, B, dist, A, y, tau, epsilon, h_min, nugget, n_unique, mu_x, Sig_ab, Z, lambda_c, lambda_sb, lambda_pb, lambda_eta_1, lambda_seta) {
    .Call(`_bdrc_gplm_me_density_evaluation_unknown_c_cpp`, theta, P, h, B, dist, A, y, tau, epsilon, h_min, nugget, n_unique, mu_x, Sig_ab, Z, lambda_c, lambda_sb, lambda_pb, lambda_eta_1, lambda_seta)
}
...
gplm_me_density_evaluation_known_c_cpp <- function(theta, P, h, B, dist, A, y, tau, epsilon, nugget, n_unique, mu_x, Sig_ab, Z, lambda_sb, lambda_pb, lambda_eta_1, lambda_seta, c) {
    .Call(`_bdrc_gplm_me_density_evaluation_known_c_cpp`, theta, P, h, B, dist, A, y, tau, epsilon, nugget, n_unique, mu_x, Sig_ab, Z, lambda_sb, lambda_pb, lambda_eta_1, lambda_seta, c)
}
...
gplm0_me_density_evaluation_unknown_c_cpp <- function(theta, h, y, A, dist, epsilon, tau, h_min, nugget, n_unique, mu_x, Sig_ab, Z, lambda_c, lambda_se, lambda_sb, lambda_pb) {
    .Call(`_bdrc_gplm0_me_density_evaluation_unknown_c_cpp`, theta, h, y, A, dist, epsilon, tau, h_min, nugget, n_unique, mu_x, Sig_ab, Z, lambda_c, lambda_se, lambda_sb, lambda_pb)
}
...
gplm0_me_density_evaluation_known_c_cpp <- function(theta, h, y, A, dist, epsilon, tau, c, nugget, n_unique, mu_x, Sig_ab, Z, lambda_se, lambda_sb, lambda_pb) {
    .Call(`_bdrc_gplm0_me_density_evaluation_known_c_cpp`, theta, h, y, A, dist, epsilon, tau, c, nugget, n_unique, mu_x, Sig_ab, Z, lambda_se, lambda_sb, lambda_pb)
}
