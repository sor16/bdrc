...
compute_bf_ti_cpp <- function(log_lik_m1, log_lik_m2, n_temperatures, n_samples, n_bootstrap) {
    .Call(`_bdrc_compute_bf_ti_cpp`, log_lik_m1, log_lik_m2, n_temperatures, n_samples, n_bootstrap)
}
