...
This software package fits a discharge rating curve based on the power-law and the generalized power-law from paired stage and discharge measurements from a given river using a Bayesian hierarchical model as described in Hrafnkelsson et al. (2020). Four models are implemented:
