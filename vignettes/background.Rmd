...
B. Hrafnkelsson, H. Sigurdarson and S. M. Gardarsson, *Generalization of the power-law rating curve using hydrodynamic theory and Bayesian hierarchical modeling.*	arXiv:2010.04769 (2020)

R. Clarke, *Uncertainty in the estimation of mean annual flood due to rating-curve indefinition.* Journal of Hydrology 222(1-4), 185–190 (1999)

R. Clarke, E. Mendiondo, L. Brusa, *Uncertainties in mean discharges from two large South American rivers due to rating curve variability.* Hydrological Sciences 45(2), 221–236 (2000)

C. Venetis, *A note on the estimation of the parameters in logarithmic stage-discharge relationships with estimates of their error.* International Association of Scientific Hydrology. Bulletin XV 2(6), 105–111 (1970)

V. Chow, *Open-Channel Hydraulics* (McGraw-Hill, New York, 1959)
