...
#     expect_equal_to_reference(bplm.fit,file='tests/testthat/cached_results/bplm.fit.rds',update=T)
#     expect_equal_to_reference(bplm.fit_known_c,file='tests/testthat/cached_results/bplm.fit_known_c.rds',update=T)
# })
