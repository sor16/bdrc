...
test_that("trace plots have known output", {
    ...
    expect_doppelganger('plm_trace_plot_hyperparameters_transformed',autoplot(plm.fit,type='trace','hyperparameters',transformed=T))
    ...
    expect_doppelganger('gplm0_trace_plot_hyperparameters_transformed',autoplot(gplm0.fit,type='trace','hyperparameters',transformed=T))
    ...
    expect_doppelganger('gplm_trace_plot_hyperparameters_transformed',autoplot(gplm.fit,type='trace','hyperparameters',transformed=T))
...
test_that("histogram have known output", {
    ...
    expect_doppelganger('plm_histogram_plot_hyperparameters_transformed',autoplot(plm.fit,type='histogram','hyperparameters',transformed=T))
    ...
    expect_doppelganger('gplm0_histogram_plot_hyperparameters_transformed',autoplot(gplm0.fit,type='histogram','hyperparameters',transformed=T))
    ...
    expect_doppelganger('gplm_histogram_plot_hyperparameters_transformed',autoplot(gplm.fit,type='histogram','hyperparameters',transformed=T))
...
test_that("rating_curve has known output", {
    ...
    expect_doppelganger('plm_rating_curve_transformed',autoplot(plm.fit,type='rating_curve',transformed=T))

    expect_doppelganger('gplm0_rating_curve',autoplot(gplm0.fit,type='rating_curve'))
    expect_doppelganger('gplm0_rating_curve_transformed',autoplot(gplm0.fit,type='rating_curve',transformed=T))

    expect_doppelganger('gplm_rating_curve',autoplot(gplm.fit,type='rating_curve'))
    expect_doppelganger('gplm_rating_curve_transformed',autoplot(gplm.fit,type='rating_curve',transformed=T))
})
...
test_that("rating_curve_mean has known output", {
    ...
    expect_doppelganger('plm_rating_curve_mean_transformed',autoplot(plm.fit,type='rating_curve_mean',transformed=T))

    expect_doppelganger('gplm0_rating_curve_mean',autoplot(gplm0.fit,type='rating_curve_mean'))
    expect_doppelganger('gplm0_rating_curve_mean_transformed',autoplot(gplm0.fit,type='rating_curve_mean',transformed=T))

    expect_doppelganger('gplm_rating_curve_mean',autoplot(gplm.fit,type='rating_curve_mean'))
    expect_doppelganger('gplm_rating_curve_mean_transformed',autoplot(gplm.fit,type='rating_curve_mean',transformed=T))
})
